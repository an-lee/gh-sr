...
// (pruneInnerDockerCache was removed by the 2026-08-15 clear+prune fold;
// the destructive prune now lives inside clearWorkTempPOSIX's appended
// prune block, executed via the same docker exec sh -c call as the clear.)
